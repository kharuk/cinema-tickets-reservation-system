...
class ExtraItem extends Component {
  state = { isSelect: !!this.props.chosenExtraServices[this.props.label] };
  ...
  checkBoxClick = () => {
    this.setState({ isSelect: this.changeSelect(this.state.isSelect) });
  };
      ...
      <div className="extra-service__item">
        ...
        {this.state.isSelect ? (
          <CountSelect
            ...
            callBackHandleClick={this.props.callBackHandleClick(
              this.props.label
            )}
          />
        ) : (
